...
namespace ConcurrencyModel
{
    ...
    public class ConcurrencyModelInitializer : DropCreateDatabaseIfModelChanges<F1Context>
    {
        protected override void Seed(F1Context context)
        {
            ...
            context.Teams.Local.Single(t => t.Id == Team.McLaren).Sponsors.Add(vodafone);
            context.Teams.Local.Single(t => t.Id == Team.Ferrari).Sponsors.Add(shell);
        }
    }
}
