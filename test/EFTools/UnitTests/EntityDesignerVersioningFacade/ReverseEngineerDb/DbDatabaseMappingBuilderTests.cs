...
namespace Microsoft.Data.Entity.Design.VersioningFacade.ReverseEngineerDb
{
    ...
    public class DbDatabaseMappingBuilderTests
    {
        ...
        [Fact(Skip = "API visibilty differences between official dll and locally built one")]
        ...
        [Fact(Skip = "Different API Visibilty between ")]
        ...
        [Fact(Skip = "Different API Visiblity between official dll and locally built one")]
